defmodule OnElixirWeb.CategoryControllerTest do
  use OnElixirWeb.ConnCase

  import OnElixir.CategoriesFixtures

  @create_attrs %{name: "some name", parent_category_id: "7488a646-e31f-11e4-aace-600308960662", posts_count: 42}
